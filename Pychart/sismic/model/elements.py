...
class BasicState(ContractMixin, StateMixin, ActionStateMixin, TransitionStateMixin):
    ...
    def __init__(self, name: str,position: str, on_entry: str = None, on_exit: str = None) -> None:
        ContractMixin.__init__(self)
        StateMixin.__init__(self, name,position)
...
class CompoundState(
    ...
    def __init__(self, name: str, position :str, initial: str = None,
...
class ShallowHistoryState(ContractMixin, StateMixin, ActionStateMixin, HistoryStateMixin):
    ...
    def __init__(self, name: str, position: str, on_entry: str = None,
